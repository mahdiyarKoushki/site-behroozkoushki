...
export const metadata = {
  title: "نصب شیرآلات در تهران",
  description:
    "نصب و تعویض شیرآلات در تهران با بهترین نصاب های شیرآلات! ✅ نصب شیرآلات بهداشتی، آشپزخانه، حمام و توالت با قیمت منصفانه و ضمانت کیفیت.",
  keywords: [
    "بهروز کوشکی",
    "نصب شیرآلات",
    "نصب سینک",
