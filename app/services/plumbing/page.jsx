...
export const metadata = {
  title: "لوله کشی تهران | لوله کش سیار ",
  description:
    "بهترین لوله کش سیار تهران را از بهروز کوشکی بخواهید! ✅ لوله کشی ساختمان، لوله کشی آب و فاضلاب، تعمیرات و نصب با قیمت مناسب و کیفیت تضمینی.",
  keywords: [
    "بهروز کوشکی",
    "لوله کشی تهران",
    "لوله کشی ساختمان",
    ...
    "تعمیر لوله",
    "لوله کش سیار",
    "لوله کش ساختمان تهران",
    "قیمت لوله کشی",
    "بهترین لوله کش تهران",
  ],
  alternates: {
  ...
  return (
    ...
    <JsonLd data={jsonLd} />
      ...
      <HeroSection
       ...
       description="ارائه انواع خدمات لوله کشی ساختمان شامل لوله کشی آب سرد و گرم، فاضلاب و گاز با بهتری�� کیفیت و نازل‌ترین قیمت توسط بهروز کوشکی"
        imageSrc="/lole4.jpg"
